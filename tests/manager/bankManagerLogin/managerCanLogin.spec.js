...
test('Assert manager can Login ', async ({ page }) => {
    ...
    await bankHomePage.assertAddCustomerButtonIsVisible();
    await bankHomePage.assertOpenAccountButtonIsVisible();
    await bankHomePage.assertCustomersButtonIsVisible();
